      ...
      {  case 0:
         ...
         case 1:
          ...
          {    glEnable(GL_DEPTH_TEST);
               printf("DEPTH_TEST ON  "); 
          } else {
               glDisable(GL_DEPTH_TEST);
               printf("DEPTH_TEST OFF "); 
          }
              break; 
         case 2:
          if(code)
...
char Info
{
 ...
 "  +/-depth       enable/disable depth test\n");
 "  +flat          flat shading\n");
 "  +smooth        smooth shading\n");
 "  -size pixels   specify pixels/triangle\n");
 "  +/-texture     enable/disable texture\n");
 "  -comp n        texture format\n");
 "  +/-linear      bilinear texture filter\n");
