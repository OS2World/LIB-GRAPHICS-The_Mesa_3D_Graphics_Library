...
static void GLUTCALLBACK _gluiDisplay(void)
{
    int lit;
...
static void GLUTCALLBACK  _gluiMouse(int button, int state, int x, int y)
{
    GLUIslider* slider = _gluiCurrentSlider();
    int side;
...
static void GLUTCALLBACK  _gluiMotion(int x, int y)
{
...
static void GLUTCALLBACK  _gluiPassive(int x, int y)
{
    GLUIslider* slider = _gluiCurrentSlider();
...
static void GLUTCALLBACK  _gluiEntry(int state)
{
    GLUIslider* slider = _gluiCurrentSlider();
